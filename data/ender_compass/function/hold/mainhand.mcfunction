...
execute if dimension minecraft:overworld run item modify entity @s weapon.mainhand ender_compass:dimension/overworld

execute if dimension minecraft:the_nether run scoreboard players set @s ender_compass.dimension 2
execute if dimension minecraft:the_nether run item modify entity @s weapon.mainhand ender_compass:dimension/the_nether

execute if dimension minecraft:the_end run scoreboard players set @s ender_compass.dimension 3
execute if dimension minecraft:the_end run item modify entity @s weapon.mainhand ender_compass:dimension/the_end

item modify entity @s weapon.mainhand ender_compass:components
item modify entity @s weapon.mainhand ender_compass:lore/base

execute if dimension minecraft:overworld run item modify entity @s weapon.mainhand ender_compass:lore/dimension/overworld
execute if dimension minecraft:the_nether run item modify entity @s weapon.mainhand ender_compass:lore/dimension/the_nether
execute if dimension minecraft:the_end run item modify entity @s weapon.mainhand ender_compass:lore/dimension/the_end
